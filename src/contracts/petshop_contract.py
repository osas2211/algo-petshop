...
class Pet:
            ...
            [
                Assert(
                    And(
                        ...
                        # The note attached to the transaction must be pet-shop:uPetsv2
                        Txn.note() == Bytes("pet-shop:uPetsv3"),
                    )
                ),
    ...
    def getAdoptFee(self, mod_contract: Expr):
        ...
        return Seq(
            get_global_fee,
            If(
                get_global_fee.hasValue(),
                App.globalPut(self.Variables.fee, get_global_fee.value()),
                App.globalPut(self.Variables.fee, Int(0)),
            ),
        )
            ...
            [
                ...
                Assert(
                    And(
                        ...
                        scratch_adopter.load() != Txn.sender(),
                    ),
                ),
